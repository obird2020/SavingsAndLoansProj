<%@ Page Title="Countries" Language="vb" AutoEventWireup="false" MasterPageFile="~/ndl.Master" CodeBehind="Countries.aspx.vb" Inherits="ndl.Countries" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <table>
            ...
            <tr>
               <td class="style1">
                  Nationality*</td>
               <td style="width: 424px">
                  <asp:TextBox ID="txtNationality" runat="server" CssClass="myText"></asp:TextBox>
               &nbsp;</td>
               <td  class="myError">
                  <asp:RequiredFieldValidator ID="vtxtValue3" runat="server" 
                     ControlToValidate ="txtNationality" ErrorMessage="Enter Nationality" />
                  <asp:CustomValidator ID="cvtxtDescription2" runat="server" 
                     ControlToValidate="txtNationality" Display="Dynamic" 
                     ErrorMessage="Nationality already exists" OnServerValidate="validatenationality" 
                     ValidateEmptyText="false" />
               </td>
            </tr>
            <tr>
   ...
   <asp:GridView ID="dgRetention" runat="server" AllowPaging="True" 
      ...
      <Columns>
         ...
         <asp:BoundField DataField="Nationality" HeaderStyle-HorizontalAlign="Left" 
            HeaderText="Nationality">
         <HeaderStyle HorizontalAlign="Left" />
         <ItemStyle Width="200px" />
         </asp:BoundField>

          <asp:BoundField DataField="def" HeaderStyle-HorizontalAlign="Left" 
            HeaderText="Default">
         <HeaderStyle HorizontalAlign="Left" />
         <ItemStyle Width="120px" />
         </asp:BoundField>
