<%@ Page Title="Bank Branches" Language="vb" AutoEventWireup="false" MasterPageFile="~/ndl.Master" CodeBehind="BanksBranches.aspx.vb" Inherits="ndl.BanksBranches" %>
   ...
   <asp:GridView ID="dgRetention" runat="server" 
      ...
      <Columns>
         ...
         <asp:TemplateField HeaderText="">
            <ItemTemplate>
               <asp:LinkButton ID="editCmd" runat="server" CausesValidation="false" commandName="editCmd" CssClass="gridUpdate">Branches</asp:LinkButton>
            </ItemTemplate>
         </asp:TemplateField>
      </Columns>
      <HeaderStyle CssClass="gridHeader" />
...
&nbsp;<asp:HiddenField ID="hdBankID" runat="server" Value="0" />
   <asp:HiddenField ID="hdBranchID" runat="server" Value="0" />
   <br />
   <br />
