<%@ Page Title="Bank Account Types" Language="vb" AutoEventWireup="false" MasterPageFile="~/ndl.Master" CodeBehind="BankAccTypes.aspx.vb" Inherits="ndl.BankAccTypes" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

   <div id="pg">
   <h3>BANK ACC TYPES</h3>
